...
const AMOUNT_TO_SEND = "0x1"; // 5 dollars = '0x32'
...
const getAllCommenterFromPost = (CommentLimit = 30, CommentOffset = 0, existingComments = []) => __awaiter(void 0, void 0, void 0, function* () {
...
app.listen(PORT, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const publicKeys = yield getAllCommenterFromPost();
